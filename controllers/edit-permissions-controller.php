...
if (isset($_POST["add-collab"])) {
    ...
    $checkedLoginCollab = htmlspecialchars($_POST["login-collab"]);
    $editPermissionsController->addCollab($checkedLoginCollab);
}

if (isset($_POST["delete-collab"])) {
    $editPermissionsController = new EditPermissionsController();
    $checkedLoginCollab = htmlspecialchars($_POST["login-collab"]);
    $editPermissionsController->removeCollab($checkedLoginCollab);
}